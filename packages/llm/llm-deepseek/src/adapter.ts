...
export class DeepSeekAdapter<C extends Connection = Connection> extends LlmAdapter {
  ...
  private async * generateTraced(options: GenerateOptions, connection: C, trace: ReasoningTrace | undefined): AsyncGenerator<StreamChunk> {
  ...
  private async * request(
    options: GenerateOptions, connection: C, signal: AbortSignal, activity: () => void, trace: ReasoningTrace | undefined,
