...
Loads named DSH profiles and their plugin bundles through the product launcher. It owns profile initialization, layered configuration, runtime resolution, and boot readiness for CLI and Desktop consumers.
