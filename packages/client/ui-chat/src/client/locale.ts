...
export const zh = {
  ...
  'message.edit.action': '编辑并重发',
  'message.edit.draft': '编辑这条用户消息',
  'message.edit.cancel': '取消',
  'message.edit.resend': '重发',
  'message.edit.resending': '重发中…',
  'message.edit.failed': '重发失败，请重试。',
  'message.edit.failed.notLast': '只能编辑最后一条用户消息。',
  'message.edit.failed.busy': '会话正在运行，请等它结束后再编辑。',
  'message.edit.failed.archived': '会话已归档，无法编辑。',
  'message.edit.failed.noUserMessage': '这个会话还没有可编辑的用户消息。',
  'message.rewind.action': '回退到这条消息之前',
  'message.rewind.marker': '已回退这一轮对话，历史仍保留在会话记录中',
  'message.rewind.failed': '回退失败，请重试。',
  'message.rewind.failed.notLast': '只能回退最后一条用户消息所在的这一轮。',
  'message.rewind.failed.busy': '会话正在运行，请等它结束后再回退。',
  'message.rewind.failed.archived': '会话已归档，无法回退。',
  'message.rewind.failed.noUserMessage': '这个会话还没有可回退的用户消息。',
  'message.rewind.failed.turnOpen': '这一轮还没有结束，暂时无法回退。',
  'message.rewind.failed.filesUnavailable': '无法撤销这一轮写过的文件，因此没有回退：工作区保持原样。',
  'message.rewind.failed.fileJournalAbsent': '这一轮的文件改动没有被记录，无法安全撤销，因此没有回退。',
  'message.rewind.failed.fileOutsideWorkspace': '这一轮改动了工作区以外的路径，无法撤销，因此没有回退。',
  'message.rewind.failed.fileUnrecoverable': '这一轮改动的文件超出可记录的大小，无法还原，因此没有回退。',
  'message.rewind.failed.fileCheckpointOverBudget': '工作区超出可记录的范围，这一轮的改动无法完整还原，因此没有回退。',
  'message.rewind.failed.fileConflict': '这一轮写过的文件在之后又被修改过，回退会丢弃那些改动，因此没有回退。',
  'message.rewind.failed.fileBlobMissing': '记录的文件内容已不在本机，无法还原，因此没有回退。',
  'message.rewind.failed.fileWorkspaceBusy': '同一工作区里还有会话在运行，无法安全还原文件，因此没有回退。',
...
export const en = {
  ...
  'message.edit.action': 'Edit and resend',
  'message.edit.draft': 'Edit this user message',
  'message.edit.cancel': 'Cancel',
  'message.edit.resend': 'Resend',
  'message.edit.resending': 'Resending…',
  'message.edit.failed': 'Resend failed. Try again.',
  'message.edit.failed.notLast': 'Only the last user message can be edited.',
  'message.edit.failed.busy': 'This session is running; edit it once the turn settles.',
  'message.edit.failed.archived': 'This session is archived and cannot be edited.',
  'message.edit.failed.noUserMessage': 'This session has no user message to edit.',
  'message.rewind.action': 'Rewind to before this message',
  'message.rewind.marker': 'Rewound this turn; the history stays in the session log',
  'message.rewind.failed': 'Rewind failed. Try again.',
  'message.rewind.failed.notLast': 'Only the turn of the last user message can be rewound.',
  'message.rewind.failed.busy': 'This session is running; rewind it once the turn settles.',
  'message.rewind.failed.archived': 'This session is archived and cannot be rewound.',
  'message.rewind.failed.noUserMessage': 'This session has no user message to rewind.',
  'message.rewind.failed.turnOpen': 'This turn has not ended yet, so it cannot be rewound.',
  'message.rewind.failed.filesUnavailable': 'Cannot undo the files this turn wrote, so nothing was rewound; the workspace is unchanged.',
  'message.rewind.failed.fileJournalAbsent': "This turn's file writes were not recorded, so they cannot be undone; nothing was rewound.",
  'message.rewind.failed.fileOutsideWorkspace': 'This turn wrote outside the workspace, which cannot be undone; nothing was rewound.',
  'message.rewind.failed.fileUnrecoverable': 'A file this turn changed is past the recordable size, so it cannot be put back; nothing was rewound.',
  'message.rewind.failed.fileCheckpointOverBudget': 'The workspace is past the recordable size, so this turn cannot be fully undone; nothing was rewound.',
  'message.rewind.failed.fileConflict': 'A file this turn wrote changed again afterwards, so rewinding would discard that work; nothing was rewound.',
  'message.rewind.failed.fileBlobMissing': 'The recorded content for a file is no longer on this machine, so it cannot be put back; nothing was rewound.',
  'message.rewind.failed.fileWorkspaceBusy': 'Another session is running in this workspace, so its files cannot be restored safely; nothing was rewound.',
