...
/**
 * Render the existing Conversation body and Composer.
 * @param props - original Conversation seats plus MainPanel-derived display phase.
 * @returns the unchanged Conversation body subtree.
 */
export function ConversationContent({
  sessionId, session, hero, useSessions, useSessionPendingInteraction,
  useWorkspaces, useInput, useComposerBlock, renderSlot, renderSlotChain,
  selectWorkspace, openWorkingDirectory,  t,
