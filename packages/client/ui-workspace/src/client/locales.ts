...
export const zh = {
  'menu.moveSession': '移动到项目…',
  'move.description': '仅修改项目归属，保留工作目录和已有文件。',
  'move.directory': '工作目录',
  'move.outside': '移到项目外',
  'move.newProject': '新建项目…',
  'move.noDirectory': '此会话没有可用的工作目录',
  'group.ungrouped': '项目外',
  'session.new': '新会话',
  'section.workspaces': '工作区',
  'section.sessions': '会话',
  'section.inProjects': '项目内会话',
  'section.outsideProjects': '项目外会话',
  ...
  'delete.desc': '将把“{name}”从工作区列表中移除。文件夹与会话记录会保留，其会话将显示在“项目外”下。',
  ...
  'actions.pin.aria': '置顶会话“{name}”',
  'actions.unpin.aria': '取消置顶会话“{name}”',
  'actions.archive.aria': '归档会话“{name}”',
...
export const en = {
  ...
  'move.description': 'Changes project membership only. Keeps the working directory and existing files.',
  'move.directory': 'Working directory',
  'move.outside': 'Move outside projects',
  'move.newProject': 'New project…',
  'move.noDirectory': 'This session has no working directory',

  'group.ungrouped': 'Outside projects',
  'session.new': 'New Session',
  'section.workspaces': 'Workspaces',
  'section.sessions': 'Sessions',
  'section.inProjects': 'Sessions in projects',
  'section.outsideProjects': 'Sessions outside projects',
  ...
  'delete.desc': 'This removes “{name}” from the workspace list. The folder and session logs will be kept. Its sessions will appear outside projects.',
  ...
  'actions.pin.aria': 'Pin session {name}',
  'actions.unpin.aria': 'Unpin session {name}',
  'actions.archive.aria': 'Archive session {name}',
