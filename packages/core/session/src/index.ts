...
export {
  deriveEventMessage, foldSurface, isAppendSurfaceEvent, isReplacementSurfaceEvent, isRewindSurfaceEvent,
  isSurfaceEvent, isSurfaceEligibleType, REWIND_SURFACE_PLUGIN,
} from './surface.ts'
