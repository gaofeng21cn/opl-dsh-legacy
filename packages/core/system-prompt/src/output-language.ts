 ...
 *
 * One settings section carries the preference; the prompt registry renders it
...
/** Settings namespace carrying the output-language preference. */
export const OUTPUT_LANGUAGE_SETTINGS_NAMESPACE = 'output-language'
...
/** Durable output-language section of the user settings document. */
