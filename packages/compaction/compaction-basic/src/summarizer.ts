...
const COMPACTION_INSTRUCTION = [
  ...
  '',
  '## Completed Work',
  '- [work already finished, with the evidence that closed it: exact commands, results, and observed output]',
  '',
  '## Verification',
  '- [every check that ran and what it proved: test names or filters, type checks, builds, measurements; state explicitly what remains unverified]',
  '',
  '## Errors and Fixes',
  ...
  '- Capture user feedback and explicit instructions faithfully, especially corrections, and keep every constraint the user stated in force.',
  '- Keep tool work continuous: for every tool call, record its id and name, what it was asked to do, and its result. A call whose result is not in this conversation is unfinished — record it as pending instead of dropping it or inventing a result. Never leave a result separated from the call it answers.',
