...
vi.mock('../src/desktop-preferences.ts', async original => ({ ...await original<typeof import('../src/desktop-preferences.ts')>(), readDesktopPreferences: () => ({ notificationsEnabled: true, closeBehavior: 'tray' }), writeDesktopPreferences: vi.fn() }))
