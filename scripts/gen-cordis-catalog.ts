...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  dshAgentShell: 'not a service: boot-provided Agent-shell selection accessor (typeof readAgentShellSelection | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
