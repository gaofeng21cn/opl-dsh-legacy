...
export const SERVICE_PAGE: Record<string, string> = {
  fileJournal: 'session.md',
  taskFeedback: 'session.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  dshAgentShell: 'not a service: launcher-provided shell selection; packages/boot/app-boot/README.md owns the boot contract',
  dshGitBashPath: 'not a service: launcher-provided executable path; packages/boot/app-boot/README.md owns the boot contract',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionPermissionsRequest: 'session.md',
  SessionPermissionsValue: 'session.md',
  SessionSelectPermissionsRequest: 'session.md',
  SessionSelectPermissionsValue: 'session.md',
  SessionEditPromptRequest: 'session.md',
  SessionEditPromptValue: 'session.md',
  SessionRewindRequest: 'session.md',
  SessionRewindValue: 'session.md',
  SessionWaitRequest: 'session.md',
  SessionWaitValue: 'session.md',
  WakeAdapter: '../../packages/api/task-feedback/README.md',
  TaskRegistration: '../../packages/api/task-feedback/README.md',
  TaskRegistrationValue: '../../packages/api/task-feedback/README.md',
  TaskLookupRequest: '../../packages/api/task-feedback/README.md',
  TaskRecord: '../../packages/api/task-feedback/README.md',
  DeliveryRecord: '../../packages/api/task-feedback/README.md',
  WakeStatus: '../../packages/api/task-feedback/README.md',
  TaskAckRequest: '../../packages/api/task-feedback/README.md',
  TaskAckValue: '../../packages/api/task-feedback/README.md',
  TaskReceiveRequest: '../../packages/api/task-feedback/README.md',
  TaskReceiveValue: '../../packages/api/task-feedback/README.md',
  TaskReceipt: '../../packages/api/task-feedback/README.md',
  TaskConsumeRequest: '../../packages/api/task-feedback/README.md',
  TaskConsumeValue: '../../packages/api/task-feedback/README.md',
  TaskResumeRequest: '../../packages/api/task-feedback/README.md',
  TaskResumeValue: '../../packages/api/task-feedback/README.md',
  TaskFlushValue: '../../packages/api/task-feedback/README.md',
  WorkspaceMoveSessionRequest: 'workspace.md',
  EffectivePermission: '../../packages/interaction/permission-presets/README.md',
  RestoreOutcome: '../../packages/session/session-rewind-files/README.md',
