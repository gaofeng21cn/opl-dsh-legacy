...
- `source`: [`packages/api/session-controller/src/index.ts:93`](../packages/api/session-controller/src/index.ts)
...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-api-task-feedback -->
<a id="deepseek-aidsh-api-task-feedback"></a>

## `@deepseek-ai/dsh-api-task-feedback`

- `inject`: `storageDomain` · `sessions` · `sessionProjections`
- `source`: [`packages/api/task-feedback/src/index.ts:122`](../packages/api/task-feedback/src/index.ts)
...
export type TaskState =
  ...
  | 'disconnected'
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-api-task-feedback -->
...
- `inject`: `subprocess`
- `refs`: [`AgentShellSettings`](../packages/shell/shell/src/index.ts) · `Volatile` (`@deepseek-ai/cordis`)
...
- `source`: [`packages/shell/bash-sandbox/src/index.ts:53`](../packages/shell/bash-sandbox/src/index.ts)
...
- `source`: [`packages/experimental/auto-review/src/index.ts:167`](../packages/experimental/auto-review/src/index.ts)
...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-session-rewind-files -->
<a id="deepseek-aidsh-session-rewind-files"></a>

## `@deepseek-ai/dsh-session-rewind-files`

- `inject`: `tools` · `sessionProjections` · `fs`
- `source`: [`packages/session/session-rewind-files/src/journal.ts:88`](../packages/session/session-rewind-files/src/journal.ts)
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-session-rewind-files -->
...
- `refs`: `Volatile` (`@deepseek-ai/cosmokit`)
...
<!-- BEGIN GENERATED config-catalog:@one-person-lab/dsh-llm-opl-gateway -->
<a id="one-person-labdsh-llm-opl-gateway"></a>

## `@one-person-lab/dsh-llm-opl-gateway`

- `inject`: `llm`
- `refs`: [`DeepSeekCatalogModel`](../packages/llm/llm-deepseek/src/index.ts) · [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts)
- `source`: [`packages/llm/llm-opl-gateway/src/config.ts:73`](../packages/llm/llm-opl-gateway/src/config.ts)
...
```
<!-- END GENERATED config-catalog:@one-person-lab/dsh-llm-opl-gateway -->
