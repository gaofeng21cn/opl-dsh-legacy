---
description: "Complete Session V4 persistence types and physical encoding references."
...
This immutable archive records the V4 Session writer before the V5 rewind-source extension. It preserves the complete declared inventory used as the V4 predecessor for the adjacent V4-to-V5 migration.
...
The inventory comes from a V4 writer checkpoint captured before the rewind message-source extension. The current writer and release status are recorded in the paired Session format status page.
...
roots:
  ...
  "event:agent/inbox/spliced": cbe418d5a3727fbd3599f90101680dae254ac1d6163b1b8b2ca30f28afb5212a
  ...
  "event:assistant/attempt": 2f1565d92801f4334f8dc34fbb980890eef621e81a7c90ed0fd8d0a6db2ec3b2
  "event:assistant/message": f219a9f66fcc92ffec27bbd96fa21ffc2cffbaf2ad1de05757ec37205b1a0b58
  ...
  "event:compaction/summary": 86c1ee9c8ab6c6e160d4ccc00b3d9ad5a6c687938b552d55eec528279baa1559
  ...
  "event:session/title-llm-request": 2a47ef7025d7dcf7e9977aadd738e7408a210b101a7dbbd37f4d87f22166eff0
  ...
  "event:system/message": 1772581b17e1fab970fda49f04ffae2a181b7992ca4efa63bffe5f8b2bd62300
  ...
  "event:team/message/queued": 9a25c2e889855516a531dc906905ec1d88157f7c2651aed27ac4f754bb128240
  ...
  "event:tool/ptc-dispatch": 75f1d59512dd2e6468bed27c6203a721b116ef7869e291e3fee34c977d013185
  "event:tool/ptc-dispatch-start": ec38b5949af8eacaf00df002f4acbe344f934f8a061e9cdc65a52a48e5f6dd93
  "event:tool/result": f4c6f3eae6607f412a9023406c8c3bd351a02451848bb78c2436f409447dd60c
  ...
  "event:user/message": 5274b395e7bf6660d020fba7e29a1e20ef2e77097fd7597e9debb13e45c540d6
...
The [complete machine inventory](v4.schema.json) contains 61 roots and 467 reachable types. Digests include all referenced fields; source names and paths describe the selected historical tree.
...
| `event:agent/inbox/spliced` | event | `cbe418d5a3727fbd3599f90101680dae254ac1d6163b1b8b2ca30f28afb5212a` | [`event:agent/inbox/spliced`](#persistence-type-eventagentinboxspliced) |
...
| `event:assistant/attempt` | event | `2f1565d92801f4334f8dc34fbb980890eef621e81a7c90ed0fd8d0a6db2ec3b2` | [`event:assistant/attempt`](#persistence-type-eventassistantattempt) |
| `event:assistant/message` | event | `f219a9f66fcc92ffec27bbd96fa21ffc2cffbaf2ad1de05757ec37205b1a0b58` | [`event:assistant/message`](#persistence-type-eventassistantmessage) |
...
| `event:compaction/summary` | event | `86c1ee9c8ab6c6e160d4ccc00b3d9ad5a6c687938b552d55eec528279baa1559` | [`event:compaction/summary`](#persistence-type-eventcompactionsummary) |
...
| `event:session/title-llm-request` | event | `2a47ef7025d7dcf7e9977aadd738e7408a210b101a7dbbd37f4d87f22166eff0` | [`event:session/title-llm-request`](#persistence-type-eventsessiontitle-llm-request) |
...
| `event:system/message` | event | `1772581b17e1fab970fda49f04ffae2a181b7992ca4efa63bffe5f8b2bd62300` | [`event:system/message`](#persistence-type-eventsystemmessage) |
...
| `event:team/message/queued` | event | `9a25c2e889855516a531dc906905ec1d88157f7c2651aed27ac4f754bb128240` | [`event:team/message/queued`](#persistence-type-eventteammessagequeued) |
...
| `event:tool/ptc-dispatch` | event | `75f1d59512dd2e6468bed27c6203a721b116ef7869e291e3fee34c977d013185` | [`event:tool/ptc-dispatch`](#persistence-type-eventtoolptc-dispatch) |
...
| `event:tool/result` | event | `f4c6f3eae6607f412a9023406c8c3bd351a02451848bb78c2436f409447dd60c` | [`event:tool/result`](#persistence-type-eventtoolresult) |
...
| `event:user/message` | event | `5274b395e7bf6660d020fba7e29a1e20ef2e77097fd7597e9debb13e45c540d6` | [`event:user/message`](#persistence-type-eventusermessage) |
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-1attachmentoriginaldimensions"></a>

#### `event:agent/inbox/spliced.data.inserted.item.content.item.variant-1.attachment.originalDimensions`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-0changes"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-0.changes`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-0changesitemaction"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-0.changes.item.action`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-12references"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-12.references`

SHA-256: `df843efd87c78cf8de98f8e0d0216956cd568d0d0e56a22c853663e274aa1a18`

Array of [`event:agent/inbox/spliced.data.inserted.item.source.variant-12.references.item`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-12referencesitem).

<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-12referencesitem"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-12.references.item`
...
<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-4entries"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-4.entries`

SHA-256: `aba175fb20ffc71112c55efe70458ff5d7dbfb83501892b4ba8d077f0ea5d7ba`

Array of [`event:agent/inbox/spliced.data.inserted.item.source.variant-4.entries.item`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-4entriesitem).

<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-4entriesitem"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-4.entries.item`
...
| `kind` | required | `"plugin"` |
| `plugin` | required | `string` |
| `sections` | required | [`event:agent/inbox/spliced.data.inserted.item.source.variant-6.sections`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-6sections) |

<a id="persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-6sections"></a>

#### `event:agent/inbox/spliced.data.inserted.item.source.variant-6.sections`
...
Sources: `packages/compaction/compaction/src/types.ts` · `packages/compaction/compaction/src/types.ts`
...
<a id="persistence-type-eventsessiontitle-llm-requestdatamessagesitemvariant-1source"></a>

#### `event:session/title-llm-request.data.messages.item.variant-1.source`
...
Sources: `packages/core/session/src/types.ts` · `packages/core/session/src/types.ts`
...
| `name` | optional | `string` |
| `originalDimensions` | optional | [`event:agent/inbox/spliced.data.inserted.item.content.item.variant-1.attachment.originalDimensions`](#persistence-type-eventagentinboxspliceddatainserteditemcontentitemvariant-1attachmentoriginaldimensions) |
| `width` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `action` | required | [`event:agent/inbox/spliced.data.inserted.item.source.variant-0.changes.item.action`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-0changesitemaction) |
...
| `changes` | required | [`event:agent/inbox/spliced.data.inserted.item.source.variant-0.changes`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-0changes) |
| `form` | required | `"instructions"` |
...
| `references` | required | [`event:agent/inbox/spliced.data.inserted.item.source.variant-12.references`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-12references) |
| `version` | required | `1` |
...
Sources: `packages/core/session/src/types.ts` · `packages/interaction/commands/src/types.ts` · `packages/interaction/commands/src/types.ts` · `packages/llm/llm/src/message.ts` · `packages/session/session-title/src/types.ts`
...
| `source` | required | [`event:session/title-llm-request.data.messages.item.variant-1.source`](#persistence-type-eventsessiontitle-llm-requestdatamessagesitemvariant-1source) |
...
| Property | Presence | Type |
|---|---|---|
| `entries` | required | [`event:agent/inbox/spliced.data.inserted.item.source.variant-4.entries`](#persistence-type-eventagentinboxspliceddatainserteditemsourcevariant-4entries) |
| `form` | required | `"catalog"` |
...
Sources: `packages/api/session-controller/src/types.ts` · `packages/attachment/attachment/src/brand.ts` · `packages/compaction/compaction/src/brand.ts` · `packages/core/session/src/types.ts` · `packages/experimental/agent-team/src/types.ts` · `packages/experimental/agent-team/src/types.ts` · `packages/experimental/agent-team/src/types.ts` · `packages/feedback/message-feedback/src/types.ts` · `packages/goal/goal/src/types.ts` · `packages/interaction/commands/src/brand.ts` · `packages/interaction/user-approval/src/types.ts` · `packages/llm/llm-retry/src/brand.ts` · `packages/llm/llm/src/brand.ts` · `packages/llm/llm/src/brand.ts` · `packages/llm/llm/src/brand.ts` · `packages/llm/llm/src/brand.ts` · `packages/schedule/schedule/src/types.ts` · `packages/session/session-title/src/index.ts` · `packages/session/session-title/src/types.ts` · `packages/webhook/webhook/src/brand.ts` · `packages/webhook/webhook/src/brand.ts` · `packages/webhook/webhook/src/brand.ts` · `packages/workflow/workflow/src/types.ts`
...
The schema is retained as a historical reference and is not regenerated from the V5 writer. V4 physical rows are decoded by the released V4 codec and then passed through the adjacent V4-to-V5 identity migration when a current reader opens them. The source file is never overwritten.
